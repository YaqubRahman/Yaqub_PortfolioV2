...
function Images(){
    return(
        ...
        <a href="https://www.gov.uk/government/organisations/defence-science-and-technology-laboratory" target="_blank">
        ...
        <a href="https://www.tcs.com/what-we-do/services/cybersecurity" target="_blank">
