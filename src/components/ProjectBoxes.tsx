      ...
      <div className="boxflex">
        <div className="box">
          ...
          <div className="pythonlogo">
            <p>
              A python game which uses<br></br>
        ...
        <div className="box">
          ...
          <div className="pythonlogo">
            <p>
              A full stack web application which uses React, JavaScript and
              MongoDB. SwiftdIn is a LinedIn<br></br>
              like clone.
            </p>
          </div>
        ...
        <div className="box">
          ...
          <div className="pythonlogo">
            <p>
              A Kotlin App, collaborated with a<br></br>
        ...
        <div className="box">
          <h1 className="title">University Street Fighter Game</h1>
          <div className="pythonlogo">
            <p>A Java game that uses City Engine</p>
          </div>
          <img
            src={UniStreetFighter}
            className="image"
            alt="unistreetfighter"
          />
        </div>
